    ...
    <div id="app">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                      <span >  <img src="/img/cor.png" style="width: 30px;margin-top: -6px;margin-right: 5px;"> </span>{{ config('app.name', 'Laravel') }}
                    </a>
                </div>
        ...
        <footer>
            <div class="text-center mt">
                <p>This is like YouTube but more Chulo. This app using Vue.js &amp; Laravel by DevelopArte</p>
            </div>
        </footer>
    </div>
